...
CREATE VIEW fada_t_schema__view AS SELECT * FROM fada_t_schema ORDER BY tv_name;
...
CREATE TABLE fada_f_schema ( -- Additional information for fields (not parsed).
    tv_name TEXT REFERENCES fada_t_schema (tv_name) ON UPDATE CASCADE,
    tv_type TEXT,
    field_index INT,
    field_name TEXT,
    field_type TEXT,
...
CREATE VIEW fada_f_schema__view AS SELECT * FROM fada_f_schema ORDER BY tv_name,field_index;
...
CREATE TABLE fada_scripts ( --- SQL and C-like scripts that can be fired via launchers.
             ...
             ---row_summary script_name,dev,modified
...
CREATE TABLE fada_launchers ( --- Additional information for menus and launchers. -- parsed ? todo
        ...
        tv_name TEXT REFERENCES fada_t_schema (tv_name) ON UPDATE CASCADE, --- Table or view to open in tab.
        script_name TEXT REFERENCES fada_scripts (script_name) ON UPDATE CASCADE, --- Table, view or script to launch.
        ...
        graph TEXT, --- Display data as a graph. 23 params separated by "|":
            ...
            ---multiline
        color TEXT) --- If unset, takes color of table or view (tv_name not empty) or takes color of 1rst menu item (Submenu).
...
INSERT INTO fada_t_schema (tv_name,tv_type,description,row_summary,readonly)
VALUES ('fada_t_schema','Table','Additional information for tables and views.','tv_name,tv_type,readonly','x'),
       ('fada_t_schema__view','View',null,null,null);

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,
                          description,
                          natural_sort,col_width,readonly,unit)
VALUES ('fada_t_schema',1,'tv_name','TEXT',
        'Name of table or view.',
        0,NULL,'x',NULL),

       ('fada_t_schema',2,'tv_type','TEXT',
       ...
       ('fada_t_schema',7,'no_data_text','TEXT',
       ...
       -- ('fada_t_schema',8,'pixmap','BLOB',
       --  'Pixmap for menu entries.',NULL,NULL,NULL,'x')

       ('fada_t_schema',9,'color','TEXT',
        'Background color for the column. If empty, the table color is used.',
        NULL,50,'x',NULL),

       ('fada_t_schema',10,'PK_field_name','TEXT',
        'Primary key.',
        NULL,NULL,'x',NULL),

       ('fada_t_schema',11,'SQLite_field_count','INT',
        'Number of field in the real SQLite table or view.',
        NULL,NULL,'x','fields'),

       ('fada_t_schema',12,'FDA_field_count','INT',
        'Number of fields with FDA properties.',
        NULL,NULL,'x','fields'),

       ('fada_t_schema',13,'Trigger_count','INT',
        'Number of triggers for this table or view.',
        NULL,NULL,'x','triggers'),

       ('fada_t_schema',14,'Internal_use_count','INT',
        'Number of calls of this table/view in triggers of other tables/views.',
        NULL,NULL,'x','calls'),

       ('fada_t_schema',15,'Menu_use_count','INT',
        'Number of menu calling this table/view.',
        NULL,NULL,'x','menus'),

       ('fada_t_schema',15,'Total_use_count','INT',
        'Number of calls of this table/view.',
        NULL,NULL,'x','menus'),

       ('fada_t_schema',17,'Rec_count','INT',
        'Number of records in the table/view.',
        NULL,NULL,'x','records') ;

UPDATE fada_f_schema SET cond_formats='::==0 #darkRed# #lightRed#' WHERE (tv_name='fada_t_schema')AND(field_name='SQLite_field_count');
UPDATE fada_f_schema SET cond_formats='::==:SQLite_field_count: #darkGreen# #lightGreen#,::!=0 #darkRed# #lightRed#' WHERE (tv_name='fada_t_schema')AND(field_name='FDA_field_count');
UPDATE fada_f_schema SET cond_formats='::==0 #darkRed# #lightRed#' WHERE (tv_name='fada_t_schema')AND(field_name='Total_use_count');

-- fada_f_schema properties (in both table t and f)

INSERT INTO fada_t_schema (tv_name,tv_type,description,readonly)
VALUES ('fada_f_schema','Table','Additional information for fields.','x'),
       ('fada_f_schema__view','View',null,null) ;

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',1,'tv_name','TEXT',
        'Name of table or view.',NULL,NULL,NULL,'x');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',2,'field_index','int',NULL,NULL,NULL,NULL,'x');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',3,'field_name','TEXT',NULL,NULL,NULL,NULL,'x');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',4,'field_type','TEXT',
        'Additional FDA field types:'||x'0a0a'||
        '''AUTOINCREMENT'' (sqlite ''INTEGER'')'||x'0a0a'||
        '''DRAWED'' (sqlite ''TEXT'')',NULL,NULL,NULL,'x');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',5,'description','TEXT',
        'Comment in the SQL CREATE TABLE statement, used for tooltip in the app.',NULL,NULL,NULL,'x');
UPDATE fada_f_schema SET multiline='x' WHERE (tv_name='fada_f_schema')AND(field_name='description');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',6,'tv_type','TEXT',
        'Table: part of the DB file where the data is stored in. data can be modified.'||x'0a0a'||
        'View: data extraction from tables or other views.'||x'0a0a'||
        'View as table: data can be modified through triggers.''.',NULL,NULL,NULL,'x');

INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',7,'natural_sort','INTEGER',
...
INSERT INTO fada_f_schema (tv_name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fada_f_schema',8,'base_data','BOOL',
