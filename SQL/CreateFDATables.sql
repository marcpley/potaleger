...
DROP TABLE IF EXISTS fda_l_schema;
CREATE TABLE fda_l_schema ( --- Additional information for menus and launchers. -- parsed ? todo
...
-- DROP VIEW IF EXISTS fda_l_schema__view;
-- CREATE VIEW fda_l_schema__view AS SELECT * FROM fda_l_schema ORDER BY name;

-----------------------------------------------------------------------
-- Set fda_t_schema properties manually because fda parser can't do it.
-----------------------------------------------------------------------

-- fda_t_schema properties (in both table t and f)
...
INSERT INTO fda_f_schema (name,field_index,field_name,field_type,
                          description,
                          natural_sort,col_width,readonly,unit)
VALUES ('fda_t_schema__view',1,'name','TEXT',
        'Name of table or view.',
        0,NULL,'x',NULL),

       ('fda_t_schema__view',2,'tbl_type','TEXT',
       ...
       ('fda_t_schema__view',3,'description','TEXT',
        'Help description used for tooltip in the app.',
        NULL,150,'x',NULL),

       ('fda_t_schema__view',4,'row_summary','TEXT',
        'Model used to calculate the row summary of the record.',
        NULL,100,'x',NULL),

       ('fda_t_schema__view',5,'goto_last','BOOL',
        'Go to last record when opening a tab.',
        NULL,NULL,'x',NULL),

       ('fda_t_schema__view',6,'can_open_tab','TEXT',
       ...
       ('fda_t_schema__view',7,'no_data_text','TEXT',
       ...
       -- ('fda_t_schema__view',8,'pixmap','BLOB',
       --  'Pixmap for menu entries.',NULL,NULL,NULL,'x')

       ('fda_t_schema__view',9,'color','TEXT',
        'Background color for the column. If empty, the table color is used.',
        NULL,50,'x',NULL),

       ('fda_t_schema__view',10,'PK_field_name','TEXT',
        'Primary key.',
        NULL,NULL,'x',NULL),

       ('fda_t_schema__view',11,'SQLite_field_count','INT',
        'Number of field in the real SQLite table or view.',
        NULL,NULL,'x','fields'),

       ('fda_t_schema__view',12,'FDA_field_count','INT',
        'Number of fields with FDA properties.',
        NULL,NULL,'x','fields'),

       ('fda_t_schema__view',13,'Trigger_count','INT',
        'Number of triggers for this table or view.',
        NULL,NULL,'x','triggers'),

       ('fda_t_schema__view',14,'Internal_use_count','INT',
        'Number of calls of this table/view in triggers of other tables/views.',
        NULL,NULL,'x','calls'),

       ('fda_t_schema__view',15,'Menu_use_count','INT',
        'Number of menu calling this table/view.',
        NULL,NULL,'x','menus'),

       ('fda_t_schema__view',15,'Total_use_count','INT',
        'Number of calls of this table/view.',
        NULL,NULL,'x','menus'),

       ('fda_t_schema__view',17,'Rec_count','INT',
        'Number of records in the table/view.',
        NULL,NULL,'x','records') ;

UPDATE fda_f_schema SET cond_formats='::==0 #darkRed# #lightRed#' WHERE (name='fda_t_schema__view')AND(field_name='SQLite_field_count');
UPDATE fda_f_schema SET cond_formats='::==:SQLite_field_count: #darkGreen# #lightGreen#,::!=0 #darkRed# #lightRed#' WHERE (name='fda_t_schema__view')AND(field_name='FDA_field_count');
UPDATE fda_f_schema SET cond_formats='::==0 #darkRed# #lightRed#' WHERE (name='fda_t_schema__view')AND(field_name='Total_use_count');

-- fda_f_schema properties (in both table t and f)
...
INSERT INTO fda_f_schema (name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fda_f_schema__view',2,'field_index','int',NULL,NULL,NULL,NULL,'x');

INSERT INTO fda_f_schema (name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fda_f_schema__view',3,'field_name','TEXT',NULL,NULL,NULL,NULL,'x');
...
INSERT INTO fda_f_schema (name,field_index,field_name,field_type,description,natural_sort,master_table,master_field,readonly)
VALUES ('fda_f_schema__view',12,'cond_formats','TEXT',
