...
INSERT INTO Params (Section, Paramètre, Description, Valeur, Unité)
    VALUES  ('Général', 'Utilisateur', 'Personne, entreprise ou organisation utilisant cette BDD Potaléger', NULL, NULL),
            ...
            ('Cultures', 'C_historique_récolte', 'Voir les saisies de récolte anciennes de', '30', 'jours'),
            ('Cultures', 'C_avance_saisie_récolte', 'Nombre de jours avant la date de début de récolte (Début_récolte) pendant lequel il est possible de saisir les récoltes', '15', 'jours'),
